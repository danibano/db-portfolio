    ...
    return (
      ...
      <div className='grid grid-flow-row gap-8 sm:grid-cols-1 md:grid-cols-2 '>
        ...
        <div className='text-center shadow-xl p-10 rounded-xl my-10'>
          ...
          <p className='text-xl py-1  text-emerald-700 hover:underline'><a href='' target='blank'>GitHub</a></p>
          <p className='text-xl py-1 text-emerald-700 hover:underline'><a href='' target='blank'>Live</a></p>
