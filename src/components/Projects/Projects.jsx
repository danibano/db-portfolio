...
const Projects = () => {
    return (
      ...
      <div className='grid grid-flow-row gap-8 sm:grid-cols-1 md:grid-cols-2 '>
        ...
        <div data-aos='fade-right' data-aos-duration='1200' className='text-center shadow-xl p-10 rounded-xl my-10'>
        ...
        <div data-aos='fade-left' data-aos-duration='1200' className='text-center shadow-xl p-10 rounded-xl my-10'>
